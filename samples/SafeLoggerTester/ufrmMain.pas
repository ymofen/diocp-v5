...
begin
  ...
  begin
    ...
    begin
      sfLogger.setAppender(TEmptyAppender4SafeLogger.Create, true);
    end else
    begin
      sfLogger.setAppender(TSingleLogFileAppender4SafeLogger.Create, true);
      TSingleLogFileAppender4SafeLogger(sfLogger.Appender).CacheSize := 0;
    end;
    __terminated := False;
    btnStart.Tag := 1;
...
begin
  ...
  begin
    ...
    sfLogger.logMessage(Format('[%d]测试[%d]', [pvWorker.DataTag, i]));
