...
uses
  Classes, diocp.socketsUtils, diocp.core.engine,
  winsock, diocp.winapiWinsock2,

  diocp.core.rawWinSocket, SyncObjs, Windows, SysUtils,
  utilsSafeLogger,
  utilsHashs,
  utilsQueues, utilsLocker, diocp.tcp.server;
...
type
  ...
  private
    FInnerBuffer: diocp.winapiWinsock2.TWsaBuf;
    FRecvBuffer: diocp.winapiWinsock2.TWsaBuf;
    FRecvdFlag: Cardinal;
    FOwner: TDiocpCustom;
...
begin
  ...
  begin
    ...
    lvRet := diocp.winapiWinsock2.WSARecv(FContext.FRawSocket.SocketHandle,
       @FRecvBuffer,
       1,
